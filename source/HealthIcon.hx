...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('steve-armor', [14, 10, 13], 0, false, isPlayer);
                animation.add('stevematt', [14, 10, 13], 0, false, isPlayer);
		...
		animation.add('alex', [20, 17, 19], 0, false, isPlayer);
                animation.add('smollalex', [20, 17, 19], 0, false, isPlayer);
                animation.add('alexsunday', [20, 17, 19], 0, false, isPlayer);
		...
		animation.add('irfan', [30, 30, 30], 0, false, isPlayer);
                animation.add('tiago', [34, 35, 35], 0, false, isPlayer);
		animation.add('tiagoswag', [36, 37, 37], 0, false, isPlayer);
                animation.add('gabo', [38, 39, 39], 0, false, isPlayer);
                animation.add('endless', [40, 41, 42], 0, false, isPlayer);
                animation.add('jeb', [43, 44, 45], 0, false, isPlayer);
		animation.play(char);
